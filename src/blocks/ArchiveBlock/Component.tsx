...
export default function ArchiveBlock(data: ArchiveBlockProps & SinglePostGlobalSetting) {
  ...
  console.log('archive page data > ', data)
  ...
  const isArchivePage = data?.isListingPage === 'yes' ? true : false
  ...
  return (
    <section className="relative overflow-hidden w-full bg-[#030531]" id="archive-block">
      ...
      <div className={`relative mx-auto max-w-7xl px-6 md:px-8`}>
        <div className={` ${isArchivePage ? 'py-12' : 'py-12 md:py-[120px]'} `}>
          {/* Header */}
          <header
            className={cx(
              'flex gap-6 flex-col mx-auto',
              `${isArchivePage ? 'pb-12' : 'pb-0'}`,
